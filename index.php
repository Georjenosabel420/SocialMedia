            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        ...
                        <span class="front-para">Discover friends from around the world</span>
                        <span class="join">Join Ibon Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2021 - Ibon</li>
                    <li style="color:#1DA1F2;"><b>- Developed By Georjen Baylosis Osabel -</b></li>
                </ul>
            </footer>
        </main>
